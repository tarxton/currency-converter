...
class CurrencyConverter {
    ...
    displayHistory() {
        ...
        this.history.forEach((conversion, index) => {
            ...
            console.log(`   ${this.getSymbol(conversion.fromCurrency)}${conversion.amount.toFixed(2)} ${conversion.fromCurrency} → ${this.getSymbol(conversion.toCurrency)}${conversion.result.toFixed(2)} ${conversion.toCurrency}`);
        });
    }
    ...
    performConversion() {
        ...
        if (result !== null) {
            console.log('\nResult:');
            console.log(`${this.getSymbol(this.fromCurrency)}${this.amount.toFixed(2)} = ${this.getSymbol(this.fromCurrency)}${result.toFixed(2)}`);
